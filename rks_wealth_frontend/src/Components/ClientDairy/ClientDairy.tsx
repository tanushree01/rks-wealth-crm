                      ...
                      {(diaryData || []).map((diarys: any) => (
                        <tr className="bg-white text-black">
                          ...
                          <td className="p-2 border">
                            {diarys.DEBT_PERCENTAGE}
                          </td>
                          <td className="p-2 border">
                            {diarys.EQUITY_PERCENTAGE}
                          </td>
                          <td className="p-2 border">
                            {diarys.HYBRID_PERCENTAGE}
                          </td>
                          <td className="p-2 border">
                            {Number(diarys.MOBILE).toFixed(0)}
                          </td>
                          <td className="p-2 border">{diarys.DATE_OF_BIRTH}</td>
                          <td className="p-2 border">
                            {diarys.IW_CREATION_DATE}
                          </td>
                          ...
                          <td className="p-2 border">
                            {diarys.DIVIDEND_PAYOUT}
                          </td>
                          <td className="p-2 border">
                            {diarys.NET_INVESTMENT}
                          </td>
                          <td className="p-2 border">
                            {diarys.PURCHASE_VALUE}
                          </td>
                          <td className="p-2 border">{diarys.CURRENT_VALUE}</td>
                          <td className="p-2 border">
                            {diarys.AVG_HOLDING_DAYS}
                          </td>
                          <td className="p-2 border">{diarys.GAIN}</td>
                          <td className="p-2 border">
                            {diarys.ABSOLUTE_RETURN}
                          </td>
